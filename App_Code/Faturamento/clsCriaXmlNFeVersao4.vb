...
Public Class clsCriaXmlNFeVersao4
  ...
  Private Sub ListaICMS(ByVal writer As XmlTextWriter, ByVal nItem As Integer)
    ...
    Try
      ...
      Select Case item.ICMS_CST
        ...
        Case 500
          ICMSSN500(writer, item.ICMS_orig, item.ICMS_vBCSTRet, item.ICMS_vICMSSTRet, icms_interest.vBCFCPST, icms_interest.pFCPST, icms_interest.vFCPST, item.ICMS_pICMSST, item.ICMS_vICMSSubstituto)
        Case 900
  ...
  Private Sub ICMSSN500(ByVal writer As XmlTextWriter, ByVal ICMS_orig As Integer, ByVal ICMS_vBCSTRet As Decimal, ByVal ICMS_vICMSSTRet As Decimal, _
                        ByVal vBCUFDestSTRet As Decimal, ByVal pFCPUFDestSTRet As Decimal, ByVal vFCPUFDestSTRet As Decimal, ByVal pST As Decimal, ByVal vICMSSubstituto As Decimal)
    ...
    writer.WriteStartElement("vICMSSubstituto")
    writer.WriteString(vICMSSubstituto.ToString("0.00").Replace(",", "."))
    writer.WriteEndElement()
